...
p_corr_lineage <- LifeSpan_ALL_MetaData %>%
  ...
  ylab('% NK cells')  + xlab('Age (years)')
p_corr_lineage


ggsave("./corplot_NK_in_lineage_03182026.pdf", p_corr_lineage,
