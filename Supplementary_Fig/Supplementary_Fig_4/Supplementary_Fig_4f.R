...
p_corr_lineage <- LifeSpan_ALL_MetaData %>%
  ...
  ylab('% B cells')  + xlab('Age (years)')
p_corr_lineage


ggsave("./corplot_B_cells_in_lineage_03182026.pdf", p_corr_lineage,
