...
#=============================================================================
# Supplementary Fig. 3k— Scatter plots of monocyte subset frequencies vs. age in infants  
#
# This script computes frequencies of three monocyte subsets 
# as a percentage of DCs,
# as scatter plots with linear regression fits and Pearson correlation coefficients.
# Input:  pbmcs_v1.rds  — available at dnehar/Lifespan_project/pbmcs_v1.rds
# Output: ./corplot_monocyte_in_lineage_infants_03182026.pdf
# =============================================================================
...
ggsave("./corplot_monocyte_in_lineage_infants_03182026.pdf", p_corr_lineage,
