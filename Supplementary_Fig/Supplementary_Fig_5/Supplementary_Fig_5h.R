...
#=============================================================================
# Supplementary Fig. 5h— Scatter plots of Tregs subset frequencies vs. age in infants  
#
...
# Output: ./corplot_Tregss_in_lineage_infants_03182026.pdf
...
ggsave("./corplot_Tregss_in_lineage_infants_03182026.pdf", p_corr_lineage,
