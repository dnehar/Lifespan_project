...
#=============================================================================
  # Supplementary Fig. 5b— Scatter plots of CD4 T cell subset frequencies vs. age 
  #
  ...
  # Output: ./corplot_CD4_T_cell_in_lineage_03182026.pdf
  # =============================================================================
...
ggsave("./corplot_CD4_T_cell_in_lineage_03182026.pdf", p_corr_lineage,
