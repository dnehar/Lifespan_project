# =============================================================================
# Figure 2d — Boxplot of pDC frequency as a percentage of DC lineage across age groups
#
# This script computes the frequency of pDC cells as a percentage of all DC
# lineage cells (moDC, cDC1, cDC2, AXL_DC, pDC) per donor, and displays their
# distribution across seven age groups as a boxplot with pairwise statistics.
# Input:  pbmcs_v1.rds  — available at dnehar/Lifespan_project/pbmcs_v1.rds
# Output: ./Boxplot_DCs_in_lineage_03132026.pdf
# =============================================================================
